...
ActiveRecord::Schema.define(:version => 20131215025117) do
  ...
  create_table "sponsorables", :force => true do |t|
    t.integer  "user_id"
  ...
  add_index "sponsorables", ["project_id"], :name => "index_sponsorables_on_project_id"
  add_index "sponsorables", ["user_id"], :name => "index_sponsorables_on_user_id"
